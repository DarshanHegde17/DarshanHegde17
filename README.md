...
- 💡 Building projects around **Full Stack Web Development** and **AI-powered applications**
- ☁️ Learning **Cloud Architecture** and how to deploy scalable, secure systems
- 🌱 Currently exploring **LLMs, RAG pipelines, and Agentic AI workflows**
- 🤝 Open to **collaborating** on full stack, AI, or open-source projects
...
<img src="https://skillicons.dev/icons?i=html,css,js,ts,react,nodejs,express,mongodb,mysql,python,java,git,github,docker,aws,figma&theme=dark" />
...
### 🤖 [Project Name Two](#)
Short one-line description — e.g. an AI-powered app, RAG pipeline, or automation tool.
...
Short one-line description of a cloud-deployed or full stack application.
...
### 🔐 [Project Name Four](#)
Short one-line description highlighting security, scalability, or a unique feature.

`TypeScript` `PostgreSQL` `JWT`
...
<a href="mailto:darshanhegdehegde@gmail.com">
<img src="https://img.shields.io/badge/Say%20Hi-00F7FF?style=for-the-badge&logo=gmail&logoColor=black"/>
</a>

<br/><br/>

<img src="https://capsule-render.vercel.app/api?type=waving&color=0:00F7FF,50:302b63,100:0f0c29&height=100&section=footer"/>
